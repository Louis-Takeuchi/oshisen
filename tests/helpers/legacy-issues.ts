/** Historical grouped stances retained only for regression tests. */
import { type Candidate, type CandidateId } from "../../lib/data.ts";
import type { AnswerValue, LegacyCandidate } from "../fixtures/legacy-data.ts";
import { getIssueQuestion } from "../../lib/issues.ts";
...
export function groupCandidatesByIssue(
  questionId: unknown,
  entries: readonly LegacyCandidate[],
